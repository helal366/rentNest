/*
  ...
  - The values [GOPIBAGBASABO] on the enum `PropertyLocation` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "PropertyLocation_new" AS ENUM ('JATRABARI', 'JURAINE', 'MOTIJHEEL', 'TIKATULI', 'DOYAGANJ', 'GULISTAN', 'MUGDA', 'MANDA', 'KAMLAPUR', 'FAKIRAPUL', 'GOLAPBAG', 'GOPIBAG', 'BASABO', 'KHILGAON', 'RAMPURA', 'BANASRI', 'HATIRJHEEL', 'DHANMONDI', 'JIGATOLA', 'FARMGATE');
